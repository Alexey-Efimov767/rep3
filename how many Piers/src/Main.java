...
public class Main {
    public static void main(String[] args) {
        ...
        while (st1.hasMoreTokens()){
            if (Objects.equals(st1.nextToken(), strCheck)){
                counter++;
            }
        }
